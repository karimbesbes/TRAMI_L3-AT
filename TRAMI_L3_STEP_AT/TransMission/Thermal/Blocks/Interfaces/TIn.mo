...
connector TIn = input Real(unit = "K") "Temperatue Signal Input" annotation (
  ...
  Icon(graphics={  Polygon(lineColor = {0, 0, 127}, fillColor = {0, 0, 127},
  ...
  Diagram(coordinateSystem(preserveAspectRatio = true, initialScale = 0.2, extent = {{-100.0, -100.0}, {100.0, 100.0}}), graphics={  Polygon(lineColor = {0, 0, 127}, fillColor = {0, 0, 127},
